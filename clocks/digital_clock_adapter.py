...
class DigitalClockAdapter(BaseDigitalClock):
    ...
    def set_date_time(self, date: datetime):
        ...
        """
        data = TimeConverter.convert_time_to_angles(date.hour, date.minute, date.second)
        self._analog_clock.set_date_time(
            year=date.year,
            month=date.month,
            day=date.day,
            hour_angle=data.hour_angle,
            minute_angle=data.minute_angle,
            second_angle=data.second_angle,
            day_night_division=data.day_night_division,
        )
    ...
    def get_date_time(self) -> datetime:
        ...
        data = TimeConverter.convert_angles_to_time(
